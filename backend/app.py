...
from backend.data_llm import DataLLM
from backend.data_retrieval import DataRetrieval
...
async def get_query_results(question: Optional[str] = None):
    """
    Endpoint for querying information using Retrieval-Augmented Generation (RAG) pipeline.

    Args:
    - question (str, optional): The question posed by the user.

    Returns:
    - dict: Response containing the answer generated by Azure OpenAI based on retrieved documents.
    """
    if not question:
